    ...
    >
      <div class="flex flex-col items-center justify-center">
        ...
        <div class="flex flex-col items-center gap-3">
            <img src="https://i.ibb.co/2KsVCXf/Single-gimmick-logo.png" class="w-16 h-16" alt="">
            <h1 class="text-6xl text-white oswald font-normal tracking-widest uppercase">Portal</h1>
        </div>
        ...
        >
          ...
          >
            ...
            <p @click="Login" class="text-base font-medium ml-4 text-gray-700">
          ...
          <div class="mt-8" @click="handleLoginWithGoogle">
            <button
             

              aria-label="Log in"
              class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-primary-dark border rounded hover:bg-primary py-4 w-full"
            >
              Log in
            </button>
          </div>
